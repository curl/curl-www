...
sub single {
    ...
    my $mirror=$$e{'re'} ne "-"?"<a href=\"https://www.curl.se/latest.cgi?curl=$$e{'re'}\">mirrored versions</a>":"";
    my $metalink=$$e{'re'} ne "-"?"<span class=\"metalink\"><a href=\"https://www.curl.se/metalink.cgi?curl=$$e{'re'}\"><img src=\"/pix/metalink.png\" border=\"0\" alt=\"\">metalink</a></span>":"";
    my $pack=$$e{'pack'};
    my $aboutver;
    my $version=$$e{'curl'};
