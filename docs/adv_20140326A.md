...
[permalink](https://curl.haxx.se/docs/adv_20140326A.html)
...
connections, named [CVE-2014-0015](adv_20140129.html))
...
[available](https://curl.haxx.se/libcurl-bad-reuse.patch)
